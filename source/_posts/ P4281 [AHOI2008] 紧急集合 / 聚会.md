...
excerpt: 题目 link 题解 弱化题目条件 如果是两个人的话，集合点肯定在这两个点的lca上 而这里是三个人，怎么办？ 猜测发现一定在其中两个人的lca上 分别求出两两的lca，3种情况分别比较大小即可 代码 #include&lt;bits/stdc++.h&gt; const int N = 5e5 + 10; using namespace std; int n, m; int read() {  ...
tags:
- oi
title: P4281
